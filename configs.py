...
def get_config():
    ...
    parser.add_argument('--weight_decay', type = float, default = 1e-5, help = "Weight decay rate (default: 1e-05)")
    ...
    parser.add_argument('--use_cpu', action = 'store_true', help = "Use cpu device (default: true)")
